...
%DIF ADD C:\users\simon\onedrive - bth\research\weed\articel\access\WeedArticleI_IEEE_Access__Copy_\access_revised_v2.tex   Fri Apr 24 12:20:53 2026
%DIF < 
%DIF < 
...
\DIFadd{Classical image-analysis approaches for weed detection often rely on color indices, vegetation indices, spectral thresholds, and handcrafted features rather than learned representations. These approaches remain important because color and vegetation-index methods, including the Excess Green Index (ExG) and the Normalized Difference Vegetation Index (NDVI), can emphasize plant material under varying soil, residue, and illumination conditions \mbox{%DIFAUXCMD
